...
export class RoleResponseDto {
  ...
  @ApiProperty({
    ...
    example: 'Frontend development role',
    required: false,
  })
  description?: string;
...
export class SpecialityResponseDto {
  ...
  @ApiProperty({
    ...
    example: 'Web development speciality',
    required: false,
  })
  description?: string;

  @ApiProperty({
    description: 'Speciality created at',
    example: '2024-01-15T00:00:00.000Z',
  })
  createdAt: Date;

  @ApiProperty({
    description: 'Speciality updated at',
    example: '2024-01-15T00:00:00.000Z',
  })
  updatedAt: Date;

  @ApiProperty({
    description: 'Speciality deleted at',
    example: '2024-01-15T00:00:00.000Z',
    required: false,
  })
  deletedAt?: Date;
